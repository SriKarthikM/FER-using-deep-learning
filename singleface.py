...
while True:
    ...
    if result is not None:
        ...
        for index, emotion in enumerate(EMOTIONS):
            ...
            cv2.putText(frame, str(int(result[0][index] * 100)), (200, index * 20 + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
        # find the emotion with maximum probability and display it
        maxindex = np.argmax(result[0])
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(frame,EMOTIONS[maxindex],(10,330), font, 1,(255,255,255),2,cv2.LINE_AA) 
